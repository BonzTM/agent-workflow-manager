...
4. Run `awm work` with the parsed identifiers plus `--tasks-json` and optional `--plan-json`.
...
- Use `/awm-review` instead when you only need to record a single review-gate outcome.
